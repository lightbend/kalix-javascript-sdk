...
TIP: To learn more about Akka Serverless entities see xref:javascript:value-entity.adoc[Implement a Value Entity], xref:javascript:eventsourced.adoc[Implement an Event Sourced Entity], and xref:javascript:replicated-entity.adoc[Implement a Replicated Entity].
...
* https://developer.lightbend.com/docs/akka-serverless/setting-up/index.html#_containers[Installing Docker]
* https://developer.lightbend.com/docs/akka-serverless/quickstart/cr-value-entity-javascript.html#_package_and_deploy_your_service[Packaging with Docker]
...
https://developer.lightbend.com/docs/akka-serverless/services/running-locally.html[running them locally] before deploying to Akka Serverless.
...
* https://developer.lightbend.com/docs/akka-serverless/projects/index.html[Working with Akka Serverless projects]
* https://developer.lightbend.com/docs/akka-serverless/services/deploy-service.html#_deploy[Deploying a packaged service]
* https://developer.lightbend.com/docs/akka-serverless/quickstart/cr-value-entity-javascript.html#_package_and_deploy_your_service[Example of how to package and deploy a service]
