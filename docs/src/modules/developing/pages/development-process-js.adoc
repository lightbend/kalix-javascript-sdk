...
https://developer.lightbend.com/docs/akka-serverless/services/running-locally.html[running them locally] before deploying to Kalix.
...
* https://developer.lightbend.com/docs/akka-serverless/projects/index.html[Working with Kalix projects]
