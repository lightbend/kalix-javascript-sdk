...
To save the work of starting from scratch, the Java https://developer.lightbend.com/docs/akka-serverless/java/kickstart.html[code generation tool] creates a project, complete with descriptors and implementations. Or, you can start from one of our https://developer.lightbend.com/docs/akka-serverless/tutorial/index.html[example applications].
