...
The Akka Serverless JavaScript SDK offers an idiomatic JavaScript language SDK
for writing components. This page describes prerequisites for JavaScript
development and basic requirements for a development project.
