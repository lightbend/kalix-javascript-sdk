...
Once you have the prerequisites, you need to add the `@kalix-io/sdk` package to your service development project, which can be done by running:

[source,sh,subs="attributes+"]
----
npm install @kalix-io/sdk@{kalix-javascript-sdk-version} --save-exact
----
...
----
{
  ...
  "version": "0.1.0",
  "dependencies": {
    "@kalix-io/sdk": "{kalix-javascript-sdk-version}"
  },
  "scripts": {
...
To run the utility manually, invoke `node_modules/@kalix-io/sdk/bin/compile-descriptor.js`.
