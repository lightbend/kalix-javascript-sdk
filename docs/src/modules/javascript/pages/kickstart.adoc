...
* A https://developer.lightbend.com/docs/akka-serverless/projects/container-registries.html[configured Docker Registry]
* An https://developer.lightbend.com/docs/akka-serverless/setting-up/index.html#_akka_serverless_account[Kalix account]
* An https://developer.lightbend.com/docs/akka-serverless/projects/index.html[Kalix project]
...
To understand how the Protobuf definitions relate to the implementation files, see https://developer.lightbend.com/docs/akka-serverless/developing/development-process-js.html#_specify_service_interface_and_domain_model[The development process] and https://developer.lightbend.com/docs/akka-serverless/services/state-model.html#_choosing_a_state_model[Understanding the programming model].
...
You can run your services locally and test them manually with HTTP or gRPC requests. To run locally, you need to initiate the Kalix https://developer.lightbend.com/docs/akka-serverless/reference/glossary.html#proxy[proxy]. The `docker-compose` file contains the configuration required to run the proxy.
...
TIP: For more details see https://developer.lightbend.com/docs/akka-serverless/services/running-locally.html[Run a service locally].
...
+
Refer to https://developer.lightbend.com/docs/akka-serverless/projects/container-registries.html[Configuring registries] for more information on how to make your docker image available to Kalix.
