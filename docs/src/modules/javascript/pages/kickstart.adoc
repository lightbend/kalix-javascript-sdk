...
* An https://developer.lightbend.com/docs/akka-serverless/projects/index.html[Akka Serverless project]
...
+
Refer to https://developer.lightbend.com/docs/akka-serverless/projects/container-registries.html[Configuring registries] for more information on how to make your docker image available to Akka Serverless.
