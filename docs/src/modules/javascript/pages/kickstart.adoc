...
* The https://docs.kalix.io/getting-started/set-up-development-env.html#_akka_serverless_cli[`akkasls` CLI downloaded]
* A https://docs.kalix.io/projects/container-registries.html[configured Docker Registry]
* An https://docs.kalix.io/setting-up/index.html#_akka_serverless_account[Kalix account]
