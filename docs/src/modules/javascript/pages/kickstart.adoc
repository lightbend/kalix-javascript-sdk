...
The code generation tools create a new development project named `my-service`, that contains build configuration and the https://docs.kalix.io/reference/glossary.html#gRPC[gRPC Protobuf specifications] for a https://docs.kalix.io/reference/glossary.html#value_entity[Value Entity].
...
[source, command window, subs="attributes"]
----
yarn create @kalix-io/kalix-service@latest my-service
----
--
