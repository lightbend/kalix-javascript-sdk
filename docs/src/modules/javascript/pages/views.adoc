...
[source,javascript]
----
include::example$js-customer-registry/integration-test/customer-registry-test.js[lines=17..30]
----
...
[source,javascript]
----
include::example$js-customer-registry/integration-test/customer-registry-test.js[lines=32..46]
----
...
[source,javascript]
----
include::example$js-customer-registry/integration-test/customer-registry-test.js[lines=48..51]
----
...
[source,javascript]
----
include::example$js-customer-registry/integration-test/customer-registry-test.js[lines=65..74]
----
