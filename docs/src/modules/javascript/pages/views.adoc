...
https://github.com/kalix-io/kalix-javascript-sdk/tree/main/samples/js/js-customer-registry[The `kalix-javascript-sdk` GitHub repository] includes an example of all views described on this page.
[#value-entity]
...
Find the complete test example https://github.com/kalix-io/kalix-javascript-sdk/blob/main/samples/js/js-customer-registry/integration-test/customer-registry-test.js[on GitHub].
