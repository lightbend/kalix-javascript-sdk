...
function GCounter() {
   ...
   * The value as a long.
   *
   * @name module:akkaserverless.replicatedentity.GCounter#longValue
   * @type {Long}
   * @readonly
   */
   ...
   * representation of the value. If you expect it to exceed `2^53`, {@link module:akkaserverless.replicatedentity.GCounter#longValue} should be
   * used instead.
   *
   * @name module:akkaserverless.replicatedentity.GCounter#value
   * @type {number}
   * @readonly
   */
