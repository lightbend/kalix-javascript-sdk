...
describe("ActionHandler", () => {
  ...
  it("should reply with returned value", () => {
    ...
    }).reply().should.eventually.have.property("field", "returned:value")
  })
  ...
  it("should reply with returned Reply message", () => {
    ...
    }).reply().should.eventually.have.property("field", "replied:message")
  })
  ...
  it("should reply with context written value (no return value)", () => {
    ...
    }).reply().should.eventually.have.property("field", "wrote:something")
  })
  ...
  it("should reply with empty message when no returned value or context.write", () => {
    ...
    }).reply().should.eventually.have.property("field", "").then(() => {
  ...
  it("should forward with returned Reply forward", () => {
    return testActionHandler("message", message => {
      return replies.forward(ExampleService.methods.DoSomething, { field: "forwarded:" + message.field })
    }).forward().should.eventually.have.property("field", "forwarded:message")
  })
  ...
  it("should reply with returned promise value", () => {
    ...
    }).reply().should.eventually.have.property("field", "promised:async:value")
  })
  ...
  it("should reply with returned async value", () => {
    ...
    }).reply().should.eventually.have.property("field", "awaited:async:value")
  })

  it("should reply with returned promise with Reply message", () => {
    return testActionHandler("message", message => {
      return doSomethingAsync(message).then(something => {
        return replies.message({ field: "promised:replied:" + something.field })
      })
    }).reply().should.eventually.have.property("field", "promised:replied:async:message")
  })
  ...
  it("should reply with returned async Reply message", () => {
    ...
    }).reply().should.eventually.have.property("field", "awaited:replied:async:message")
  })
  ...
  it("should reply with context written value in returned promise", () => {
    ...
    }).reply().should.eventually.have.property("field", "promised:wrote:async:value")
  })
  ...
  it("should reply with context written value in async function", () => {
    ...
    }).reply().should.eventually.have.property("field", "awaited:wrote:async:value")
  })
  ...
  it("should reply with empty message when returned promise is fulfilled with undefined", () => {
    return testActionHandler("ignored", message => {
      ...
      expect(console.log.firstCall).to.have.been.calledWithExactly("received:ignored")
      expect(console.log.secondCall).to.have.been.calledWithExactly("then:async:ignored")
    })
  })
  ...
  it("should forward with returned promise with Reply forward", () => {
    return testActionHandler("message", message => {
      return doSomethingAsync(message).then(something => {
        return replies.forward(ExampleService.methods.DoSomething, { field: "forwarded:promised:" + something.field })
      })
    }).forward().should.eventually.have.property("field", "forwarded:promised:async:message")
  })

  it("should forward with returned async Reply forward", () => {
    return testActionHandler("message", async message => {
      const something = await doSomethingAsync(message)
      return replies.forward(ExampleService.methods.DoSomething, { field: "forwarded:awaited:" + something.field })
    }).forward().should.eventually.have.property("field", "forwarded:awaited:async:message")
  })

  it("should forward with (deprecated) context forwarded message in returned promise", () => {
    return testActionHandler("message", (message, context) => {
      return doSomethingAsync(message).then(something => {
        context.forward(ExampleService.methods.DoSomething, { field: "forwarded:promised:" + something.field })
      })
  ...
  it("should reply by flattening nested promises", () => {
    ...
    }).reply().should.eventually.have.property("field", "nested:promised:async:async:something")
  })
